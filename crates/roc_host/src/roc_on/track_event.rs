use crate::roc_on::meta_message::MetaMessage;
use crate::roc_on::midi_message::MidiMessage;
...
impl core::fmt::Debug for UnionTrackEventKind {
    fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
        f.write_str("UnionTrackEventKind")
    }
}
